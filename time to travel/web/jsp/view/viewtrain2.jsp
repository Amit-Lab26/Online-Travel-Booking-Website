<%-- 
    Document   : viewtrain2
    Created on : May 17, 2020, 9:40:33 PM
    Author     : admin
--%>
...
<html>
   ...
   %>
    ...
    width:100%;
      ">
          <form name="trainbookform" action="../Bookform/trainbookform.jsp">
             <table  style="
...
<c:forEach items="${sessionScope.returntrain}" var="train">    
 <tbody align="center" style="margin-top: 10px;
    ...
    <tr align="center" style="color:blueviolet;font-weight: bold;font-variant: small-caps">
            ...
            <td style="margin-top: 10px;">Rs.<c:out value="${train.tfare*train.usrdis/10}"/></td>
              ...
              <input type="hidden" name="trainid2" value="${train.trainid}"/>
              <input type="hidden" name="tname2" value="${train.tname}"/>
              <input type="hidden" name="tfrm2" value="${train.tfrm}"/>
              <input type="hidden" name="tto2"  value="${train.tto}"/>
              <input type="hidden" name="deptime2" value="${train.deptime}"/>
              <input type="hidden" name="artime2" value="${train.artime}"/>
              <input type="hidden" name="avldate2" value="${train.avldate}"/>
              <input type="hidden" name="arrdate2" value="${train.arrdate}"/>
              <input type="hidden" name="usrsrc2" value="${train.usrsrc}"/>
              <input type="hidden" name="usrdes2" value="${train.usrdes}"/>
              <input type="hidden" name="usrdis2" value="${train.usrdis}"/>
              <input type="hidden" name="usrstt2" value="${train.usrstt}"/>
              <input type="hidden" name="usrstd2" value="${train.usrstd}"/>
              <input type="hidden" name="tfare2" value="${train.tfare}"/>
              <input type="hidden" name="tclass2" value="<%=cl%>"/>
              <input type="hidden" name="tfs2" value="${train.fSenior}" />
              <input type="hidden" name="tfc2" value="${train.fSenior}" />
              <input type="hidden" name="ttax2" value="${train.ttax}" />
              </td>
         </tr>
  </tbody>
