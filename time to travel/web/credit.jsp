<%-- 
    Document   : credit
    Created on : Mar 15, 2020, 12:39:25 PM
    Author     : admin
--%>
...
<tr align="center"><td> <p style="color: darkblue;opacity: 0.9;font-size: 25px;margin-top: 5%;">Please Fill the Following Details</p></td>
                         ...
                         color: black;" >
                    <option  value="0" selected="" disabled="">Select credit-card type</option>
                    <option value="sbi">SBI</option>
                    <option value="icci">ICCI</option>
                    <option value="hdfc">HDFC</option>
                    
        </select></td></tr>
<tr  align="center"><td><input align="center" type="tel" name="ppnh" placeholder="Enter your credit card number" style="height:30px;width:80%;
                      border-radius: 5px; background-color: white;opacity: 0.8;font-size: 20px;margin-top: 5%;
                      color: black;"></td></tr>
<tr  align="center"><td><input align="center" type="text" name="pname" placeholder="Enter your credit card name" style="height:30px;width:80%;
                      border-radius: 5px; background-color: white;opacity: 0.8;font-size: 20px;margin-top: 5%;
                      color: black;"></td></tr>
<tr align="center"><td><input align="center" type="password" name="ppass" placeholder="Enter your credit card  pin" style="height:30px;width:80%;
                      border-radius: 5px; background-color: white;opacity: 0.8;font-size: 20px;margin-top: 5%;
                      color: black;"></td></tr>
